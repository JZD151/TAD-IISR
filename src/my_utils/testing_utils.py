...
def parse_args_paired_testing(input_args=None):
   ...
   """
    ...
    # New degradation encoder / re-degradation net (match modified training)
    parser.add_argument("--de_enc_path", type=str, default=None, help="Path to de_enc_net checkpoint (state_dict).")
    parser.add_argument("--re_de_path", type=str, default=None, help="Path to re_de_net checkpoint (state_dict).")
    parser.add_argument("--save_redegraded", action="store_true", help="Save re-degraded LR image predicted by re_de_net.")
    parser.add_argument("--redegraded_dir", type=str, default=None, help="Optional output dir for re-degraded LR images. Defaults to --output_dir.")
    ...
    parser.add_argument("--val_batch_size", type=int, default=1, help="Inference batch size (requires uniform image sizes).")
